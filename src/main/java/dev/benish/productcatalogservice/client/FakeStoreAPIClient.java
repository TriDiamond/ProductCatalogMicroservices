package dev.benish.productcatalogservice.client;
...
public class FakeStoreAPIClient {
    ...
    public Boolean validateResponse(ResponseEntity<FakeStoreProductDto> responseEntity){
    ...
    public Boolean validateResponseForArray(ResponseEntity<FakeStoreProductDto[]> responseEntity){
        if(responseEntity.hasBody()
                && responseEntity.getStatusCode().equals(HttpStatusCode.valueOf(200))) {
            return true;
        }
